...
var parsePagesDir = function (input, output, ignorePath, pageExtensions, appDirQueryLength) {
    ...
    var getImportName = function (file) {
        var result = (0, parseQueryFromTS_1.parseQueryFromTS)(output, file, appDirQueryLength + imports.length);
        if (result) {
