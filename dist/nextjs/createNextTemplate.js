...
var createNextTemplate = function (input, output, ignorePath, appDir, pageExtensions) {
    ...
    var appDirData = appDir
        ...
        : { imports: [], text: '' };
    var pagesDir = input
        ? (0, parsePagesDir_1.parsePagesDir)(input, output, ignorePath, pageExtensions, appDirData.imports.length)
        : { imports: [], text: '' };
