...
exports.default = (function (_a, mode) {
    var type = _a.type, input = _a.input, staticDir = _a.staticDir, output = _a.output, ignorePath = _a.ignorePath, trailingSlash = _a.trailingSlash, basepath = _a.basepath, pageExtensions = _a.pageExtensions, appDir = _a.appDir;
    var emptyPathRegExp = /\n.+{\n+ +}.*/;
    if (mode !== 'static') {
        var text = '';
        switch (type) {
    ...
    if (staticDir && mode !== 'pages') {
        var text = (0, createStaticTemplate_1.createStaticTemplate)(staticDir, basepath, ignorePath);
        while (emptyPathRegExp.test(text)) {
            text = text.replace(emptyPathRegExp, '');
        }
        prevStaticText = text;
